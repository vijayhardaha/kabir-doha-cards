 ...
 * The component renders the author's name with a decorative underline and ensures
 * proper accessibility through ARIA attributes and screen reader text.
 *
 * @component
...
const AuthorSignature = ({ customAuthor = 'Sant Kabir Das' }: { customAuthor?: string }): JSX.Element => {
  ...
  return (
    <div className="relative mt-[var(--kdc-author-sign-block-mt)] block" aria-label={screenReaderText}>
      <span
        className="text-2xl font-semibold whitespace-nowrap"
        style={{ fontSize: 'var(--kdc-author-sign-text-fs)', lineHeight: 'var(--kdc-author-sign-text-lh)' }}
      >
        &mdash; {customAuthor}
      </span>
      <span
        className="relative left-[var(--kdc-author-sign-underline-l)] text-[var(--kdc-color)]"
      ...
      >
        <svg
          ...
          style={{ width: 'var(--kdc-author-sign-underline-w)', height: 'var(--kdc-author-sign-underline-h)' }}
        >
          <path
